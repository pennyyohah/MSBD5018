...
with open("results/distilbert-spans-pred.txt") as distilbert,open("results/spanbert_token_spans-pred.txt") as spanbert,open("results/roberta_token_spans-pred.txt") as roberta, \
        open("ensemble_union.txt","w") as output:
    i = 0
    while True:
        ...
        result = distilbert_in.union(spanbert_in)
